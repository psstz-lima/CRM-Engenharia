-- CreateEnum
CREATE TYPE "CompanyType" AS ENUM ('OWNER', 'CLIENT', 'PARTNER');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('CONTRACT_EXPIRING', 'MEASUREMENT_PENDING', 'ACTION_REQUIRED', 'SYSTEM_ALERT');
