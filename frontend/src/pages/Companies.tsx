...
import { AlertCircle, Building2, Edit2, Plus, Trash2 } from 'lucide-react';
...
export function Companies() {
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-6 animate-fadeIn">
            ...
            {error && (
                <div className="bg-red-500/10 border border-red-500/20 text-red-600 px-4 py-3 rounded-xl flex items-center gap-2 animate-fadeIn">
                    <AlertCircle size={20} />
                    <span>{error}</span>
                </div>
            )}
                                        ...
                                        <td className="p-4 text-center">
                                            <div className="flex justify-center gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="p-2 rounded-lg hover:bg- text- hover:text-red-500 transition-colors"
                                                    title="Excluir"
                                                >
                                                    <Trash2 size={16} />
                                                </button>
            ...
            {showDeleteModal && (
                ...
                >
                    <div className="grid gap-4 text-center">
                        <div className="w-16 h-16 rounded-full bg-red-500/10 flex items-center justify-center mx-auto text-red-600">
                            <Trash2 size={32} />
                        </div>
                        <p className="text-">
                            Tem certeza que deseja excluir esta empresa? Esta açõo não pode ser desfeita e pode afetar contratos vinculados.
                        </p>

                        {error && (
                            <div className="bg-red-500/10 p-3 rounded-lg text-red-600 text-sm">
                                {error}
                            </div>
                        )}
